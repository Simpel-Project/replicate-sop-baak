      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="hidden md:block">
          <ul class="ml-10 flex items-center space-x-8">
            ...
            <li class="relative">
              <button @click="toggleDropdown('profil')" class="flex items-center hover:text-[#E2C665] transition-colors duration-200">
                <span>Profil</span>
                <svg 
              ...
              <div v-if="activeDropdown === 'profil'" class="absolute z-10 mt-2 w-48 rounded-b-sm shadow-lg bg-zinc-800">
                <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                  <a href="#" class="block px-4 py-2 text-sm hover:bg-zinc-950 hover:text-[#E2C665]" role="menuitem">Sub Menu 2</a>
                  <a href="#" class="block px-4 py-2 text-sm hover:bg-zinc-950 hover:text-[#E2C665]" role="menuitem">Sub Menu 1</a>
                </div>
              </div>
            </li>
            <li>
              <a href="#" class="hover:text-[#E2C665] transition-colors duration-200">Data Statistik</a>
            </li>
          </ul>
        </div>
      </div>
